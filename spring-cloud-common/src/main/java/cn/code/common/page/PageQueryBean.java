...
public class PageQueryBean<T> {
    ...
    public final List<T> getItems() {
        return this.items == null ? (List<T>) Collections.emptyList() : this.items;
    }
    ...
    public static <T> PageQueryBeanBuilder<T> builder() {
        return new PageQueryBeanBuilder();
    }
    ...
    public static class PageQueryBeanBuilder<T> {
        ...
        public PageQueryBeanBuilder<T> pageNum(final Integer pageNum) {
            this.pageNum = pageNum;
            return this;
        }

        public PageQueryBeanBuilder<T> pageSize(final Integer pageSize) {
            this.pageSize = pageSize;
            return this;
        }

        public PageQueryBeanBuilder<T> totalRows(final int totalRows) {
            this.totalRows = totalRows;
            return this;
        }

        public PageQueryBeanBuilder<T> startRow(final Integer startRow) {
            this.startRow = startRow;
            return this;
        }

        public PageQueryBeanBuilder<T> totalPage(final Integer totalPage) {
            this.totalPage = totalPage;
            return this;
        }

        public PageQueryBeanBuilder<T> items(final List<T> items) {
            this.items = items;
            return this;
        }

        public PageQueryBeanBuilder<T> subRows(final Integer subRows) {
            this.subRows = subRows;
            return this;
        }
