...
public class ResponseTemplate<T> {
    ...
    public static <T> ResponseTemplate.ResponseTemplateBuilder<T> builder() {
        return new ResponseTemplate.ResponseTemplateBuilder();
    }
    ...
    public static class ResponseTemplateBuilder<T> {
        ...
        public ResponseTemplate.ResponseTemplateBuilder<T> success(final Boolean success) {
            this.success = success;
            return this;
        }

        public ResponseTemplate.ResponseTemplateBuilder<T> msg(final String msg) {
            this.msg = msg;
            return this;
        }

        public ResponseTemplate.ResponseTemplateBuilder<T> code(final String code) {
            this.code = code;
            return this;
        }

        public ResponseTemplate.ResponseTemplateBuilder<T> data(final T data) {
            this.data = data;
            return this;
        }
