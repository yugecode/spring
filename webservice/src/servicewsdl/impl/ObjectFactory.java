 ...
 * generated in the service.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://impl.service/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://impl.service/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: service.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service/", name = "queryWeatherResponse")
